...
# 🧠 Simple Explanation:
# Imagine a number line — just a straight line with numbers going from negative to positive.
# You can draw a line segment between two points, like from -3 to 2. This segment includes every number between -3 and 2.
#
...
# 📘 Exercise:
# Write a function are_lines_touching_or_overlapping(start1, end1, start2, end2) that returns True if the two 1D line
# segments are overlapping or touching, and False if they are completely separate.
#
