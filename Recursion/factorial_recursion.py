...
# Now, there's a smart way to compute factorials using something called recursion. In recursion, a function calls itself with a
# smaller input to eventually solve a problem.
# Example logic:
...
# Exercise:
# Write a function factorial_recursive(n) that takes one argument n (a non-negative integer) and returns the factorial of
...
#
#
# print(factorial_recursive(3))  # Output: 120)
